...
int main() 
{
    ...
    while (isActive) {
        ...
        cout << '\n' << "Чебышевская норма по всему множеству точек для df с O(h^2): " << norm1 << '\t' << "Точка, в которой достигается норма: " << x0 + h * dot1 << '\n';
        cout << "Чебышевская норма по всему множеству точек для df с O(h^4): " << norm2 << '\t' << "Точка, в которой достигается норма: " << x0 + h * dot2 << '\n';
        cout << "Чебышевская норма по всему множеству точек для ddf с O(h^2): " << norm3 << '\t' << "Точка, в которой достигается норма: " << x0 + h * dot3 << '\n';
